...
export async function generateChatSummary(parentChatId: string): Promise<string | null> {
  try {
    ...
    const { text: summary } = await generateText({
      ...
      prompt: `Analyze this conversation and create a summary of our conversation with regards to everthing we've discussed so far, showing the evolution of how we went from the start of this conversation into the current conclusion.
